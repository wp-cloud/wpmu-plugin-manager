...
== Description ==
Plugin management for Wordpress Multisite that supports the native plugins page and the WPMU DEV Supporter plugin! Used on thousands of multisite installs across the web.
...
Also, if you use the excellent <a href="http://premium.wpmudev.org/project/supporter?ref=prayhumbly-3442">Supporter plugin from WPMU DEV</a> you will be able to charge for access to certain plugins!
...
= Do I need the Supporter plugin installed? =
Not at all, but if you install the <a href="http://premium.wpmudev.org/project/supporter?ref=prayhumbly-3442">Supporter plugin from WPMU DEV</a> the options to charge for access to certain plugins will appear in the dropdowns.
